      ...
      resolve([
        {
          ...
          description: 'High-level dashboard for executive decision-making',
          lastModified: '2023-03-18',
        },
        {
          id: 2,
          name: 'Marketing Campaign Performance',
          description: 'Real-time tracking of marketing campaign effectiveness',
          lastModified: '2023-03-19',
        },
        {
          id: 3,
          name: 'Supply Chain Monitoring',
          description: 'End-to-end visibility of supply chain operations',
