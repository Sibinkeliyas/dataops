...
def setup_embeddings_service(
    ...
    print(f'azure_credential: {azure_credential}')
    print(f'type(azure_credential): {type(azure_credential)}')
    ...
    if openai_host != "openai":
        ...
        print(f'azure_open_ai_credential: {azure_open_ai_credential}')
        print(f'type(azure_open_ai_credential): {type(azure_open_ai_credential)}')
        return AzureOpenAIEmbeddingService(
            ...
            open_ai_api_version=openai_api_version or "2024-06-01",
...
if __name__ == "__main__":
    ...
    use_acls = os.getenv("AZURE_ADLS_GEN2_STORAGE_ACCOUNT") or os.getenv("USE_USER_UPLOAD")
